        ...
        <div className='flex items-center flex-col w-[95vw] sm:w-[85vw] md:w-[80vw] text-[#FAF0E6]'>
            ...
            {wishlistopen? 
                ...
                <thead className='w-full'>
                    <tr className='flex w-full justify-evenly bg-[#FFD700] rounded-md text-sm sm:text-base '>
                ...
                <tbody className='w-full mb-4'>
                    {
                        watchlist.map((coinid) => (
                            <tr  className=' flex w-full justify-evenly  py-2 text-xs vs:text-base hover:bg-[#FFD700] text-[#FAF0E6] hover:font-bold hover:text-black rounded-md cursor-pointer'>
